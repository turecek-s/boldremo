  ...
  return (
    ...
    >
      <nav className="container-custom flex items-center justify-between" aria-label="Main navigation">
        ...
        >
          <span className="inline-flex flex-col items-center bg-primary px-5 py-2.5 rounded-xl shadow-lg shadow-primary/20 ring-1 ring-primary-foreground/10">
            ...
            <span className="text-[10px] font-medium tracking-[0.2em] uppercase text-primary-foreground/80 mt-1">
